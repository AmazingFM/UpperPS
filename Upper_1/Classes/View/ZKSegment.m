...
#define ZK_ItemFontSize 15.0f
#define ZK_ItemMargin 0.0f
...
- (void)commonInit {
    ...
    self.zk_itemDefaultColor = ZK_UIColorFromRGBAlpha(255.0f, 255.0f, 255.0f, 1.0f);
    self.itemStyleSelectedColor = ZK_UIColorFromRGBAlpha(255.0f, 0.0f, 0.0f, 1.0f);
    switch (self.segmentStyle) {
        case ZKSegmentLineStyle:
            self.zk_itemSelectedColor = ZK_UIColorFromRGBAlpha(255.0f, 255.0f, 255.0f, 1.0f);
            break;
    ...
    self.segmentBackgroundColor = ZK_UIColorFromRGBAlpha(238.0f, 238.0f, 238.0f, 0.3f);
